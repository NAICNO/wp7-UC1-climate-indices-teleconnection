#!/bin/bash
# Setup script for NAIC Teleconnection Demonstrator
# Run this after cloning: ./setup.sh

set -e

echo "=== NAIC Teleconnection Demonstrator Setup ==="
echo ""
...
echo "  Option B: python scripts/lrbased_teleconnection/main.py --help"
echo ""
echo "Quick test:"
echo "  python scripts/lrbased_teleconnection/main.py \\"
echo "      --data_file dataset/noresm-f-p1000_slow_new_jfm.csv \\"
echo "      --target_feature amo2 \\"
echo "      --modelname LinearRegression \\"
echo "      --max_allowed_features 3 \\"
echo "      --end_lag 30"
echo ""
